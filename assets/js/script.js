...
const deckCards = ["zoro.png", "zoro.png", 
                    "brook.png", "brook.png", 
                    "chopper.png", "chopper.png",
                    "franky.png", "franky.png",
                    "jinbei.png", "jinbei.png", 
                    "luffy.png", "luffy.png", 
                    "nami.png", "nami.png", 
                    "robin.png", "robin.png",
                ];
...
function startGame() {
	...
	for (const element of shuffledDeck) {
		// Create the <li> tags
		...
		addImage.setAttribute("src", "../assets/img/" + element + "?raw=true");
